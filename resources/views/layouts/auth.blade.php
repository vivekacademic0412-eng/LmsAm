...
<div class="shell">
    ...
    <section class="hero-side">
        ...
        <img class="bitmoji" src="{{ asset('theme/images/bitmoji.png') }}" alt="Academic Mantra"
            title="Bitmoji Academic Mantra" loading="lazy">
...
<script>
    ...
    eyeBtn?.addEventListener('click', () => {
        ...
        eyeBtn.setAttribute('aria-label', visible ? 'Show password' : 'Hide password');
    });
