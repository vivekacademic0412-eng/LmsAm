...
<body>
    <div class="cert-outer">
        <div class="cert-inner">
            ...
            <div class="cert-badge-type">CERTIFICATE </div>
            ...
            <div class="cert-name-line">{{ auth()->user()->name ?? 'Student Name' }}</div>

            <div class="cert-body">
                Has successfully completed the demo session in
                <span class="cert-blank">{{ $demo->course->name ??$course->name ?? 'Subject' }}</span>
            ...
            <div class="cert-stats">
                <table>
                    <tr>
                        <td><span class="stat-value">{{ '100' }}%</span>Demo Completion</td>
                        <td><span class="stat-value">{{ $demo->grade ?? 'A' }}</span>Grade</td>
                        {{-- <td><span class="stat-value">{{ $demo->certificateNumber ?? '—' }}</span>Certificate No.</td> --}}
                    </tr>
                </table>
            </div>
            ...
            <div class="cert-footer">
                <table>
                    <tr>
                        <td>
                            <div class="cert-line"></div>{{ $issuedAt ?? now()->format('d M Y') }}<br>Date
                        </td>
                        {{-- <td>
                            <div class="cert-line"></div>Subject: {{ $subjectName ?? '—' }}
                        </td> --}}
                        <td>
                            <div class="cert-line"></div>Signature
                        </td>
                    </tr>
                </table>
            </div>
