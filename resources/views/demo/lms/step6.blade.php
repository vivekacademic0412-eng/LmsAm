    ...
    <section class="completion-page">
        ...
        <div class="completion-top">
            <div class="success-icon {{ $isApproved ? 'ok' : ($isRejected ? 'bad' : 'pending') }}">
                <i
                    class="fas {{ $isApproved ? 'fa-circle-check' : ($isRejected ? 'fa-circle-xmark' : 'fa-hourglass-half') }}"></i>
            </div>
            ...
            <p>
                @if ($isApproved)
                    ...
                    @if ($paymentType == 'free')
                        ...
                        your payment is successful, the <strong>Download Certificate</strong> button will be unlocked
                        instantly.
                    @else
                ...
                @else
                    Thank you for completing your demo! Your submission has been successfully received and is currently
                    under review. Once your trainer approves your performance, your certificate will be unlocked in your
                    dashboard. You'll receive a notification, and a Download Certificate button will become available so you
                    can access your certificate instantly.
                @endif
            </p>
