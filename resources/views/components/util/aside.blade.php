<aside class="sidebar" id="mainSidebar">
    ...
    <nav class="sb-nav" role="navigation" aria-label="Main navigation">
        ...
        @if ($user->role === \App\Models\User::ROLE_STUDENT)
            ...
            <a href="{{ route('profile.edit') }}" class="sb-item {{ $isActive('profile.edit') ? 'active' : '' }}">
        ...
        @else
            ...
            @if ($user->role === \App\Models\User::ROLE_IT)
                ...
                <a href="{{ route('panel.it') }}" class="sb-item {{ $isActive('panel.it') ? 'active' : '' }}">
            ...
            @if (in_array($user->role, [
                ...
                <div class="sb-group {{ $courseGroupActive ? 'open' : '' }}" data-group="courses">
                    <button type="button" class="sb-group-trigger {{ $courseGroupActive ? 'has-active' : '' }}"
            ...
            @if (in_array($user->role, [\App\Models\User::ROLE_SUPERADMIN, \App\Models\User::ROLE_ADMIN]))
                ...
                <div class="sb-group {{ $studentGroupActive ? 'open' : '' }}" data-group="students">
                    <button type="button" class="sb-group-trigger {{ $studentGroupActive ? 'has-active' : '' }}"
                ...
                <div class="sb-group {{ $sysGroupActive ? 'open' : '' }}" data-group="system">
                    <button type="button" class="sb-group-trigger {{ $sysGroupActive ? 'has-active' : '' }}"
                ...
                @endphp
                @php
                    $demoGroupActiveStages = $isActive('admin.feedbacks')|| $isActive('admin.demo-students')|| $isActive('admin.demo-submission-stage');
                @endphp

                <div class="sb-section">Demo</div>

                <div class="sb-group {{ $demoGroupActive ? 'open' : '' }}" data-group="demo">
                    <button type="button" class="sb-group-trigger {{ $demoGroupActive ? 'has-active' : '' }}"
                ...
                <div class="sb-group {{ $demoGroupActiveStages ? 'open' : '' }}" data-group="demo">
                    <button type="button" class="sb-group-trigger {{ $demoGroupActiveStages ? 'has-active' : '' }}"
                        aria-expanded="{{ $demoGroupActiveStages ? 'true' : 'false' }}">
                        <i class="ti ti-device-desktop item-icon" aria-hidden="true"></i>
