        ...
        <section class="media-viewer-card">
            @if ($hasReadAloud)
                ...
                >
                    ...
                    <div class="read-aloud-buttons">
                        <button type="button" class="btn btn-soft" data-read-aloud-play>Speak</button>
                        <button type="button" class="btn btn-soft" data-read-aloud-pause disabled>Pause</button>
                        <button type="button" class="btn btn-soft" data-read-aloud-resume disabled>Resume</button>
                        <button type="button" class="btn btn-soft" data-read-aloud-stop disabled>Stop</button>
                    </div>
                </div>
            @endif
            ...
            @if (!empty($downloadUrl) && !empty($allowDownload))
                <div class="viewer-actions">
                    <a class="btn btn-soft" href="{{ $downloadUrl }}" target="_blank" rel="noopener">Download Original</a>
                </div>
