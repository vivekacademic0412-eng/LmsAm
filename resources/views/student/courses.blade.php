        ...
        <section class="card">
            <div class="page-head">
                <div>
                    ...
                    <p>Your enrolled courses appear first. All courses are grouped by category below.</p>
                </div>
            </div>
        </section>
        ...
        <section class="card">
            ...
            <div class="course-grid">
                @forelse ($enrolledCourses as $course)
                    ...
                    @endphp
                    <a class="course-tile" href="{{ route('student.courses.show', $course) }}">
                ...
                <div class="tab-panel {{ $index === 0 ? 'active' : '' }}" data-tab-panel="{{ $category->id }}">
                    ...
                    <div class="course-grid">
                        @forelse ($tabCourses as $course)
                            ...
                            @endphp
                            @if ($enrolled)
                                <a class="course-tile" href="{{ route('student.courses.show', $course) }}" data-subcat="{{ $subCategoryId }}">
                                    <div class="course-tile-top" style="background-image: {{ $bg }};">
                                        <h3>{{ $course->title }}</h3>
                                    </div>
                                    <div class="course-tile-body">
