        ...
        <tr>
            <td align="center">
                ...
                <table width="700" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <!-- CONTACT STRIP -->
                    <tr>
                        <td style="padding:22px 40px;background:#0B3D91;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        <table cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td style="padding:0 18px;white-space:nowrap;font-size:14px;">
                                                    <span style="color:#F58220;">&#9742;&nbsp;</span>
                                                    <a href="tel:+919779455997"
                                                        style="color:#FFFFFF !important;text-decoration:none !important;font-weight:bold;">
                                                        +91 97794 55997
                                                    </a>
                                                </td>
                                                ...
                                                <td style="padding:0 18px;white-space:nowrap;font-size:14px;">
                                                    <span style="color:#F58220;">&#127760;&nbsp;</span>
                                                    <a href="https://www.academicmantraservices.com" target="_blank"
                                                        style="color:#FFFFFF !important;text-decoration:none !important;font-weight:600;">
                    ...
                    <tr>
                        <td style="background:#FFFFFF;padding:40px;">
                            <table width="100%">
                                ...
                                <tr>
                                    <td style="font-size:14px;color:#4B5563;line-height:28px;">

                                        <strong style="font-size:18px;color:#0B3D91;">
                                            Academic Mantra Services
                                        </strong>

                                        <br><br>

                                        Empowering Students with AI-Integrated, Industry-Focused Live Training
                                        Programs,
                                        Professional Certifications and Career Development.

                                        <br><br>

                                        <strong style="color:#0B3D91;">Registered Office</strong>
                                        ...
                                        <a href="tel:+919779455997"
                                            style="color:#F58220;text-decoration:none;font-weight:600;">
                                            +91 97794 55997
                                        </a>
                                        ...
                                        <a href="https://wa.me/919779455997"
